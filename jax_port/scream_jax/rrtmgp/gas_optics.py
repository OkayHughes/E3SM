...
Sources:
  cpp/rrtmgp/kernels/mo_gas_optics_kernels.h (RRTMGP_ENABLE_KOKKOS
    variants: interpolation, gas_optical_depths_major/minor,
    compute_tau_absorption, compute_tau_rayleigh, compute_Planck_source,
    combine_and_reorder_2str, interpolate1D)
  cpp/rrtmgp/mo_gas_optics_rrtmgp.h (GasOpticsRRTMGPK::compute_gas_taus,
    ::source, ::get_col_dry, ::gas_optics)
  cpp/rrtmgp/mo_rrtmgp_constants.h (grav/m_dry/m_h2o/avogad defaults —
    EAMxx never calls init_constants)
